...
class PageMenuState extends State<PageMenu> {
  ...
  Widget build(BuildContext context) {
    dados.clear();
    dados.add({'titulo': 'Parceiros Raiz', 'subtitulo': 'Conheça nossos parceiros',        "icone": LineAwesomeIcons.pagelines});
    dados.add({'titulo': 'Contate-nos',    'subtitulo': 'Dúvidas, opiniões ou sugestões?', "icone": LineAwesomeIcons.phone});
    dados.add({'titulo': 'Sobre o App',    'subtitulo': 'Saiba mais sobre o Raiz',         "icone": LineAwesomeIcons.mobile_phone});
            ...
            children: <Widget>[
              Row(children: <Widget>[
                ...
                Column(
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text(registro['titulo'], style: TextStyle(fontWeight: FontWeight.w500, color: Colors.grey[800]), textScaleFactor: 1.10,),
                ...
                Container(
                  ...
                  child:
                  Icon(Icons.arrow_forward_ios, color: global.cor_secundaria, size: 15),
                )
